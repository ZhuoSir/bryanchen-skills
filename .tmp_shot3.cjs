...
(async () => {
  ...
  await page.goto('file:///Users/bryanchen/Documents/work/my_workspace/bryanchen-skills/.tmp_diagram_trans.html');
  await new Promise(r => setTimeout(r, 500));
  const svg = await page.$('svg');
  await svg.screenshot({ path: '/Users/bryanchen/Documents/work/my_workspace/bryanchen-skills/.tmp_diagram_trans.png', omitBackground: true });
  await browser.close();
  console.log('done');
